...
//                 <div>
//                   <h3 className="text-gray-500 text-sm font-medium">Payment Refund</h3>
//                   <p className="text-2xl font-semibold mt-1">{statusCounts?.paymentStatus?.REFUNDED || 0}</p>
//                 </div>
...
//                   <p className="text-2xl font-semibold mt-1">{statusCounts?.orderStatus?.CANCELED || 0}</p>
//                 </div>
...
//               <div className="flex justify-between items-center">
//                 <div>
//                   <h3 className="text-gray-500 text-sm font-medium">Order Shipped</h3>
//                   <p className="text-2xl font-semibold mt-1">{statusCounts?.deliveryStatus?.SHIPPED || 0}</p>
//                 </div>
...
//               <div className="flex justify-between items-center">
//                 <div>
//                   <h3 className="text-gray-500 text-sm font-medium">Order Delivering</h3>
//                   <p className="text-2xl font-semibold mt-1">{statusCounts?.deliveryStatus?.DELIVERED || 0}</p>
//                 </div>
...
//                             })}
//                           </TableCell>
//                           <TableCell className="text-blue-500">{order.customerName}</TableCell>
//                           <TableCell>{order.priority}</TableCell>
//                           <TableCell>{formatCurrency(order.totalAmount)}</TableCell>
//                           <TableCell>{getPaymentStatusBadge(order.paymentStatus)}</TableCell>
//                           <TableCell>{order.itemsCount || order.orderItems?.length || 0}</TableCell>
...
//                   onValueChange={(value) => handleStatusChange("orderStatus", value)}
//                 >
...
//                   onValueChange={(value) => handleStatusChange("deliveryStatus", value)}
//                 >
